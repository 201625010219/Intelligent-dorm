...
I2C_HandleTypeDef  TOUCH_I2C_Handle; 
...
static void I2C_Mode_Config(void)
{
    ...
    TOUCH_I2C_Handle.Instance = GTP_I2C;

    TOUCH_I2C_Handle.Init.Timing           = 0x90913232;//50KHz

    TOUCH_I2C_Handle.Init.OwnAddress1      = 0;

    TOUCH_I2C_Handle.Init.AddressingMode   = I2C_ADDRESSINGMODE_7BIT;

    TOUCH_I2C_Handle.Init.DualAddressMode  = I2C_DUALADDRESS_DISABLE;

    TOUCH_I2C_Handle.Init.OwnAddress2      = 0;

    TOUCH_I2C_Handle.Init.OwnAddress2Masks = I2C_OA2_NOMASK;

    TOUCH_I2C_Handle.Init.GeneralCallMode  = I2C_GENERALCALL_DISABLE;

    TOUCH_I2C_Handle.Init.NoStretchMode    = I2C_NOSTRETCH_DISABLE;

    /* Init the I2C */

    HAL_I2C_Init(&TOUCH_I2C_Handle);	
    HAL_I2CEx_AnalogFilter_Config(&TOUCH_I2C_Handle, I2C_ANALOGFILTER_ENABLE); 
}
...
{
  HAL_I2C_Master_Receive(&TOUCH_I2C_Handle,ClientAddr,pBuffer,NumByteToRead,1000);    
  return 0;
}
...
{
  HAL_I2C_Master_Transmit(&TOUCH_I2C_Handle,ClientAddr,pBuffer,NumByteToWrite,1000);
  return 0;  
